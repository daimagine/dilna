...
<div class="widget">
    <div class="whead">
        <h6>Warehouse Updated Price Report :: List</h6>
        <div class="clear"></div>
    </div>
                ...
                <div class="grid6">
                    ...
                    <div class="grid7">
                        ...
                        <div class="grid5 searchLine" style="margin-top: 0px">
                            <input type="text" id="price" name="price" class="ac ui-autocomplete-input" autocomplete="off" role="textbox" aria-autocomplete="list" aria-haspopup="true" value="{{$price}}"></button>
                        </div>
                    </div>
                    <div class="clear" style="padding-bottom: 15px;"></div>
    ...
    <div id="dyn2" class="shownpars overflowtable">
        ...
        <table cellpadding="0" cellspacing="0" border="0" class="dTableWarehouseItem" dtable-sortlist="[[0,'desc']]">
            ...
            <tr class="">
                ...
                <td>{{ $d->code }}</td>
                <td>{{ $d->price }}</td>
                @if($d->status == statusType::ACTIVE)
                <td>Used</td>
                @elseif($d->status == statusType::INACTIVE)
                <td>Not used</td>
                @else
                <td></td>
                @endif
