...
(function ($) {
    ...
    $.configureBoxes = function (options) {
        ...
        $('#' + settings[index].up1).click(function () {
            MoveUp(group1[index]);
        });
        $('#' + settings[index].up2).click(function () {
            MoveUp(group2[index]);
        });
        $('#' + settings[index].down1).click(function () {
            MoveDown(group1[index]);
        });
        $('#' + settings[index].down2).click(function () {
            MoveDown(group2[index]);
        });
    };

    function MoveUp(group){
        $('#' + group.view + ' option:selected').each(function(){
            $(this).insertBefore($(this).prev());
        });
    }
    function MoveDown(group){
        $('#' + group.view + ' option:selected').each(function(){
